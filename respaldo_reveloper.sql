...
INSERT INTO `django_content_type` VALUES (1,'admin','logentry'),(3,'auth','group'),(2,'auth','permission'),(4,'contenttypes','contenttype'),(10,'Reveloper','evaluacion'),(6,'Reveloper','proyecto'),(8,'Reveloper','tareadesarrollada'),(7,'Reveloper','tareapordesarrollar'),(9,'Reveloper','usuario'),(5,'sessions','session');
...
INSERT INTO `django_session` VALUES ('hf8sbdg13g8lqx5ztspf3zhu9q3fu9wh','.eJxVjDEOwyAQBP9CHaHD2JxJmd5vQAcHwUkEkrGrKH-PLblImi12ZvctHG1rdluLi5tZXIUSl9_OU3jGcgB-ULlXGWpZl9nLQ5EnbXKqHF-30_07yNTyvvaYRqCEkZG1TQxmIBhNint2A4PXoAMqDQSkibjHSKY3yirbIVkvPl_17zfw:1tEE5X:viUFuVdSgN3Eqvl3qq1gZCJuZ5dOQHxqszq4df12134','2024-12-05 20:47:43.785046');
...
INSERT INTO `reveloper_proyecto` VALUES ('EC1','Ecommerce1','Desarrollo de Ecommerce1.','2024-11-18','2024-11-30','activo'),('PW1','Pagina_web1','Desarrollo de la primera página web.','2024-11-17','2024-11-30','activo');
/*!40000 ALTER TABLE `reveloper_proyecto` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `reveloper_tareadesarrollada`
--

DROP TABLE IF EXISTS `reveloper_tareadesarrollada`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `reveloper_tareadesarrollada` (
  `descripcion` longtext COLLATE utf8mb4_general_ci NOT NULL,
  `fecha_entrega` datetime(6) NOT NULL,
  `tarea_por_desarrollar_id` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  PRIMARY KEY (`tarea_por_desarrollar_id`),
  CONSTRAINT `Reveloper_tareadesar_tarea_por_desarrolla_51ac77de_fk_Reveloper` FOREIGN KEY (`tarea_por_desarrollar_id`) REFERENCES `reveloper_tareapordesarrollar` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `reveloper_tareadesarrollada`
--

LOCK TABLES `reveloper_tareadesarrollada` WRITE;
/*!40000 ALTER TABLE `reveloper_tareadesarrollada` DISABLE KEYS */;
/*!40000 ALTER TABLE `reveloper_tareadesarrollada` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `reveloper_tareapordesarrollar` VALUES ('CCSSPW1','Crear CSS Página web 1','Creación del CSS de la primera página web.','2024-11-17 23:00:05.448633','2024-11-30','en progreso','PW1',2),('HTMLPW1','Crear la plantilla HTML','Desarrollo de la plantilla HTML para la página web1.','2024-11-18 18:22:40.577685','2024-11-30','en progreso','PW1',2),('LEC1','Login Ecommerce1','Desarrollo de login para ecommerce1','2024-11-18 18:14:57.276806','2024-11-30','en progreso','EC1',3),('ModPW1','Modal Pagina web 1','Desarrollo de un modal para la lista de usuarios en página web 1.','2024-11-21 13:23:44.316910','2024-11-30','en progreso','PW1',2);
...
INSERT INTO `reveloper_usuario` VALUES (1,'pbkdf2_sha256$870000$UHUmp03yQyxxngyGg2qbJj$5XZY7xL2RpQWyvXOIV+VZFC0z2rpIi6LdRKcM0i77+I=','2024-11-21 20:47:43.733226',1,'admin','Admin','Reveloper','admin@reveloper.com',1,1,'2024-11-17 20:13:35.000000','','','2024-11-17 20:13:35.866556'),(2,'pbkdf2_sha256$870000$Sf3u9K9jYwJMKNXJwJFZyu$Tazyv0sD1+iyj59docz/RFiqqFT2yPa52qf6oSDfBvY=','2024-11-21 17:17:19.238586',0,'Developer1','Roberto Emilio','González Guzmán','developer1@reveloper.com',0,1,'2024-11-17 22:55:02.000000','','','2024-11-17 22:55:02.900689'),(3,'pbkdf2_sha256$870000$zsS8wDfDBZLS3TAOU4qKsM$Au0aKp76U632zIZ5rMuvSxLyxtVnfod6uxk207BXkMM=','2024-11-18 18:25:03.368183',0,'Developer2','Pedro','Villegas','developer2@reveloper.com',0,1,'2024-11-18 18:10:44.000000','','','2024-11-18 18:10:45.771775'),(4,'pbkdf2_sha256$870000$K0uXkgihP5E7XoP8DGZdP0$aBduZTLgMDPtOa7wbUJnITBnjjMdnQSM+ieZBjhRGzM=','2024-11-21 17:09:37.451439',0,'Developer3','María','Quiroz','developer3@reveloper.com',0,1,'2024-11-21 13:15:12.000000','','','2024-11-21 13:15:13.603530');
...
INSERT INTO `reveloper_usuario_user_permissions` VALUES (1,1,1),(2,1,2),(3,1,3),(4,1,4),(5,1,5),(6,1,6),(7,1,7),(8,1,8),(9,1,9),(10,1,10),(11,1,11),(12,1,12),(13,1,13),(14,1,14),(15,1,15),(16,1,16),(17,1,17),(18,1,18),(19,1,19),(20,1,20),(21,1,21),(22,1,22),(23,1,23),(24,1,24),(25,1,25),(26,1,26),(27,1,27),(28,1,28),(29,1,29),(30,1,30),(31,1,31),(32,1,32),(33,1,33),(34,1,34),(35,1,35),(36,1,36),(37,1,37),(38,1,38),(39,1,39),(40,1,40);
...
-- Dump completed on 2024-11-21 18:59:01
