...
if not SECRET_KEY:
    raise ImproperlyConfigured("La variable de entorno DJANGO_SECRET_KEY no está configurada.")
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'templates', BASE_DIR / 'Reveloper' / 'templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATIC_URL = 'static/'
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'Reveloper', 'static')]
